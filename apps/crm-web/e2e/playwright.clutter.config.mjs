...
const sharedEnv = {
  ...process.env,
  NODE_ENV: 'test',
  APP_NAME: 'pulse-clutter-qa',
  APP_VERSION: '0.1.0-clutter-qa',
  PORT: '4100',
  LOG_LEVEL: 'error',
...
export default defineConfig({
  ...
  reporter: 'list',
  outputDir: path.join(repoRootDir, 'output', 'playwright', 'ux-05-clutter-test-results'),
  use: {
