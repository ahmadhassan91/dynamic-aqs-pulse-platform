...
// Screenshot capture pass. Reuses the e2e stack (API:4100 + built web:3101) and runs
// screenshots.spec.mjs to capture full-page PNGs of the implemented surfaces.
...
const sharedEnv = {
  ...process.env,
  NODE_ENV: 'test',
  APP_NAME: 'pulse-shots',
  APP_VERSION: '0.1.0-shots',
  PORT: '4100',
  LOG_LEVEL: 'error',
...
export default defineConfig({
  ...
  reporter: 'list',
  outputDir: path.join(repoRootDir, 'output', 'playwright', 'crm-web-shots-run'),
  use: {
