...
const routeInventory = [
  ...
  waived('/dealer/cart', 'dealer-task', 'Dealer cart is a new order task route; functional order coverage is release-blocking, visual promotion follows dealer portal UX cleanup.', 'Dealer Portal', '2026-07-15', ['functional-e2e-pending']),
  ...
  waived('/dealer/orders', 'dealer-task', 'Dealer order history is a new self-service task route; full visual-budget promotion follows cart and dealer-order UAT.', 'Dealer Portal', '2026-07-15', ['functional-e2e-pending']),
  ...
  waived('/notifications', 'task-route', 'Notification inbox is a cross-module task surface; visual-budget promotion follows notification routing UAT.', 'Notifications', '2026-07-15', ['functional-e2e-pending']),
  waived('/orders', 'task-route', 'Internal order triage is a permissioned task route; visual cleanup follows order queue UAT.', 'Orders', '2026-07-15', ['functional-e2e-pending']),
  ...
  waived('/settings/notifications', 'settings-task', 'Notification preference settings are a focused configuration route, not a default workbench.', 'Notifications', '2026-07-15', ['functional-e2e-pending']),
  waived('/settings/notifications/routing', 'settings-task', 'Notification routing rules are an admin configuration route; functional routing coverage is release-blocking, visual cleanup follows routing UAT.', 'Notifications', '2026-07-15', ['functional-e2e-pending']),
