...
export const ROLE_DEFAULT_ACTION_ACCESS_CATALOG: Record<AuthRole, WorkspaceActionKey[]> = {
  ...
  SALES_BD_REP: ['reference.view', 'lead.view', 'customer.view', 'customer.create', 'customer.edit', 'customer.activity_log', 'contact.view', 'contact.create', 'location.view', 'location.create', 'lead.intake_manage', 'product.view', 'digital_asset.view', 'digital_asset.download', 'digital_asset.share', 'reports.builder'],
  ...
  REGIONAL_DIRECTOR: ['reference.view', 'lead.view', 'customer.view', 'contact.view', 'location.view', 'territory.admin', 'territory.reassign', 'training.schedule', 'product.view', 'digital_asset.view', 'digital_asset.download', 'digital_asset.share', 'digital_asset.usage_view', 'consignment.view', 'consignment.audit', 'reports.builder'],
