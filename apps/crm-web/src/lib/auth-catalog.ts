...
export const ROLE_DEFAULT_ACTION_ACCESS_CATALOG: Record<AuthRole, WorkspaceActionKey[]> = {
  ...
  SALES_BD_REP: ['reference.view', 'lead.view', 'customer.view', 'customer.create', 'customer.edit', 'customer.activity_log', 'contact.view', 'contact.create', 'location.view', 'location.create', 'lead.intake_manage', 'product.view', 'digital_asset.view', 'digital_asset.download', 'reports.builder'],
  SALES_BD_LEADERSHIP: ['reference.view', 'admin.role_view', 'admin.audit_view', 'admin.system_health_view', 'lead.view', 'customer.view', 'customer.create', 'customer.edit', 'customer.activity_log', 'contact.view', 'contact.create', 'location.view', 'location.create', 'lead.intake_manage', 'lead.finance_queue_view', 'product.view', 'digital_asset.view', 'digital_asset.download', 'digital_asset.usage_view', 'reports.builder'],
  ...
  TERRITORY_MANAGER: ['reference.view', 'lead.view', 'customer.view', 'customer.create', 'customer.edit', 'customer.activity_log', 'contact.view', 'contact.create', 'location.view', 'location.create', 'lead.consignment_approve', 'territory.reassign', 'training.schedule', 'product.view', 'digital_asset.view', 'digital_asset.download', 'consignment.view', 'consignment.audit', 'reports.builder'],
  REGIONAL_DIRECTOR: ['reference.view', 'lead.view', 'customer.view', 'contact.view', 'location.view', 'territory.admin', 'territory.reassign', 'training.schedule', 'product.view', 'digital_asset.view', 'digital_asset.download', 'digital_asset.usage_view', 'consignment.view', 'consignment.audit', 'reports.builder'],
  TRAINING_OPS: ['reference.view', 'training.catalog_manage', 'training.schedule', 'product.view', 'product.asset_link', 'digital_asset.view', 'digital_asset.download', 'digital_asset.usage_view', 'reports.builder'],
  DEALER_PORTAL_USER: [],
};
